import { SafeAreaView, View, StyleSheet, ScrollView } from "react-native"; // Import StyleSheet
// Components 
import TextWithColor from "@/app/shared/components/TextWithColor";
import { useRoute } from "@react-navigation/native";
import ActionsCitaCont from "./ActionsCitaCont";

// utils
import { formatTimeUntil } from "@/app/shared/services/formatDateUntil";
import { RenderTypeStatus } from "../../components/RenderTypeStatus";
import { MiniCard } from "../../CitasUser/components/MiniCard";
// interfaces
...
export default function CitaDetailsCont({ navigation }: INavGlobal) {    
    ...
    return (
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            ...
            <SafeAreaView style={styles.safeArea}>
                ...
                <ActionsCitaCont item={item} navigation={{ navigation: navigation }}/>
            </SafeAreaView>
        </ScrollView>
    );
    }
